...
plot '< grep 2003-01-01 rir_prefixes.txt' using 3:xtic(2) every ::12 title '2003', \
	 ...
	 '< grep 2006-01-01 rir_prefixes.txt' using 3:xtic(2) every ::12 title '2006', \
	 '< grep 2007-01-01 rir_prefixes.txt' using 3:xtic(2) every ::12 title '2007', \
	 '< grep 2008-01-01 rir_prefixes.txt' using 3:xtic(2) every ::12 title '2008', \
	 '< grep 2009-01-01 rir_prefixes.txt' using 3:xtic(2) every ::12 title '2009', \
	 '< grep 2009-04-23 rir_prefixes.txt' using 3:xtic(2) every ::12 title 'May 2009'
